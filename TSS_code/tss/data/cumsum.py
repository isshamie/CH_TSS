...
def get_cum_and_plot(peaks_dict, tissues_order, f_save=None):
    """
...
def wrap_venn(all_peaks,tissues,venn_f):
    venn = pd.DataFrame(index=["mRNA", "Distal", "ATAC"],
                        columns=["CHO", "Tissues", "Overlap"])
    cho = ["CHO"]
